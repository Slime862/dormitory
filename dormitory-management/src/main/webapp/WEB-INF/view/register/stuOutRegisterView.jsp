    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="gridSystemModalLabel">离校登记</h4>
            </div>
            <div class="modal-body">
                <form id="register_Form" class="form-horizontal">
                    <div class="form-group">
                        <label for="leavetime" class="col-sm-2 control-label">离校时间</label>
                        <div class="col-sm-9">
                            <input type="date" class="form-control" id="leavetime" name="leavetime">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="city" class="col-sm-2 control-label">去向</label>
                        <div class="col-sm-9">
...
<script type="text/javascript">
    ...
    var outRegisterId = '${outRegisterId}';
    ...
    function tableInit() {
        $('#tb_register').bootstrapTable({
            url: '/register/stuOutHistoryList', //请求后台的URL（*）
            method: 'get', //请求方式（*）
    ...
    function btn_save() {
        ...
        var city = $("#city").val();
        if (time == null || time == "" || city == null || city == "") {
            alert("输入不能为空！");
            return;
        }

        $.ajax({
            url: "/register/isStuSaveOutRegister",
            type: "get",
            success: function (data) {
                if (data) {
                    $.post("/register/saveStuOutRegister", {
                        leavetime: new Date(time),
                        outRegisterId: outRegisterId,
                        city: city
                    }, function (res) {
                        if (res) {
