    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="gridSystemModalLabel">创建离校登记</h4>
            </div>
...
<script type="text/javascript">
    ...
    function tableInit() {
        $('#tb_register').bootstrapTable({
            url: '/register/outRegisterList', //请求后台的URL（*）
            method: 'get', //请求方式（*）
    ...
    function btn_save() {
        ...
        $.ajax({
            url: "/register/isCreateOutRegister",
            type: "get",
            success: function (data) {
                if (data) {
                    $.post("/register/createOutRegister", $("#register_Form").serialize(), function (res) {
                        if (res) {
    ...
    // 进入历史
    function inHistory() {
        $.get("/register/createOutHistory", function (res) {
            if (res) {
                $('#tb_register').bootstrapTable('refresh');
                alert("操作成功！");
            } else {
