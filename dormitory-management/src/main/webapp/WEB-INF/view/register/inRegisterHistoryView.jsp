...
<div style="line-height: 34px;">
    <label class="col-sm-2 control-label" style="width: 10.666667%;">入校登记分类</label>
    <div class="col-sm-3">
...
<script type="text/javascript">
    ...
    // 导出
    function exportInfo() {
        var form = $("<form action='/register/inExportExcel' method='get'></form>");
    ...
    function tableInit() {
        $('#tb_register').bootstrapTable({
            url: '/register/inHistoryList', //请求后台的URL（*）
            method: 'get', //请求方式（*）
