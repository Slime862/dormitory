...
<script type="text/javascript">
    ...
    var option = {
        url: '/staff/repairHistory', //请求后台的URL（*）
        method: 'get', //请求方式（*）
    ...
    //初始化Table
    function tableInit() {
        $('#tb_repairHistory').bootstrapTable(option);
    };

    // 下拉选择
    function reasonChange() {
        $('#tb_repairHistory').bootstrapTable('destroy');
        $('#tb_repairHistory').bootstrapTable(option);
    }

    // 导出
    function exportInfo() {
        var form = $("<form action='/staff/exportExcel' method='get'></form>");
